        ...
        <div className="footer-div">
            ...
            <div className="footer-div2">
                <h5 className="footer-text2">
                    Тетя Марта Надвое Стая Сказки Пушкина. Для взрослых Домашнее
                    поле Трудные подростки 4 сезон The Тёлки Happy
                    End(Хэппи-энд) Псих Чики СТС Рассказ служанки 5 сезон
                </h5>
            </div>
